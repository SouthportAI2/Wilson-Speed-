...
import { Facebook, Instagram, Calendar, CheckCircle, PenTool, Image as ImageIcon, Upload, X } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-slate-800 rounded-xl border border-slate-700 p-6">
        ...
        <div className="space-y-4">
          ...
          >
            {isGenerating ? 'AI Creating Magic...' : 'Generate Engaging Post'}
          </button>
          ...
          {generatedDraft && (
            <div className="mt-6 bg-slate-900 rounded-lg p-4 border border-purple-500/30 animate-fade-in">
              ...
              <div className="mt-4 flex gap-3">
                <button className="flex-1 py-2 bg-slate-800 border border-slate-600 hover:bg-slate-700 rounded-lg text-sm text-white">Edit</button>
                <button 
                  onClick={handleSchedule}
                  className="flex-1 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-sm text-white font-medium"
                >
                  Schedule Post
                </button>
              </div>
